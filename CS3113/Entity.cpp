...
Entity::Entity(Vector2 position, Vector2 scale, const char *textureFilepath,
               TextureType textureType, Vector2 spriteSheetDimensions, std::map<Direction, std::vector<int>> animationAtlas, EntityType entityType) : mPosition{position}, mVelocity{0.0f, 0.0f},
                    ...
                    Entity *collidableEntities, int collisionCheckCount)
{
    ...
    if (mTextureType == ATLAS && mIsCollidingBottom)
        animate(deltaTime);
}
